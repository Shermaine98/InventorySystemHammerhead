...
<html>
    ...
    <head>
        ...
        <script>
            ...
            var i;
              <% int i= 0; %>;
            for (  i = 0; i < <%=PurchaseOrder.size()%>; i++)
            {
    ...
    <div id= "center" align="center">
        <form method="POST" action="ConsumptionReportServlet">
            ...
            <div id="display"><h4>ITO UNG NAGPAPALIT</h4></div> 
            ...
            <table id="dataTable" class="table table-hover" style= "width:800px">
                ...
                <tr>
                    ...
                    <td><%= PurchaseOrder.get(y).getItemDescription()%></td>
                     <td><%= PurchaseOrder.get(y).getSupplier()%></td>
                    ...
                    <td><%= PurchaseOrder.get(y).getDeliverySchedule()%></td>
                </tr>
            </table>
