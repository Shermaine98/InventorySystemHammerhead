...
<html>
    ...
    <body>  
    <br/><br/><br/>
    <center><h2>Encode Supplier</h2></center>
                ...
                <table class="tableContainer" style="width:500px">
                    ...
                    <tbody id="dataTable" class="scrollContent">
                        <tr>
                            ...
                            <td><input type="text" name="CompanyName" size="16"/></td>                    
                            <td><input type="text" name="CompanyAddress" size="16"/></td>                   
                            <td><input type="text" name="ContactPerson" size="16"/></td>                   
                            <td><input type="text" name="ContanctNumber" size="16"/></td>
                        </tr>
                    </tbody>
                </table>
